      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="/" className="text-gray-400 hover:text-blue-400 transition-colors duration-300 text-sm">Ana Sayfa</a></li>
              <li><a href="/favorites" className="text-gray-400 hover:text-blue-400 transition-colors duration-300 text-sm">Favorilerim</a></li>
              <li><a href="/?category=chest" className="text-gray-400 hover:text-blue-400 transition-colors duration-300 text-sm">Göğüs Egzersizleri</a></li>
              <li><a href="/?category=back" className="text-gray-400 hover:text-blue-400 transition-colors duration-300 text-sm">Sırt Egzersizleri</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-sm text-gray-400">
                ...
                <span>iletisim@egzersizrehberi.com</span>
              </li>
              <li className="flex items-start gap-3 text-sm text-gray-400">
                <svg className="w-5 h-5 text-blue-400 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="border-t border-gray-700 pt-6 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <p className="text-sm text-gray-400">
            © {currentYear} Egzersiz Rehberi. Tüm Hakları Saklıdır.
          </p>
          ...
          <p className="text-sm text-gray-400">
            <span className="font-medium">Geliştirici:</span> Özgür Enes Osanmaz
          </p>
        </div>
      </div>
    </footer>
